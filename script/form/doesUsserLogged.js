export function usserLogged() {
    ...
    document.addEventListener("DOMContentLoaded" , ()=>{
        ...
        if (usserLoggedIn) {
            let cartProduct = JSON.parse(localStorage.getItem("loged in"))?.cart;

            dynamicHeader.insertAdjacentHTML("beforeend" , 
                `<div class="cart basic-gray">
                <a href="../html/cart.html" class="basic-flex">
            ...
            dynamicHeader.insertAdjacentHTML("beforeend" , 
                `<div class="signin-signup basic-gray">
                        <a href="./html/login.html" class="basic-flex">
