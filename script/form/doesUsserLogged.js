    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (usserLoggedIn) {
            ...
            dynamicHeader.insertAdjacentHTML(
                ...
                <a href="${window.location.pathname == `/Iran-Nike-website/html/store.html` ? `./cart.html` : `./html/cart.html` }" class="basic-flex">
            ...
            const baseUrl = window.location.origin + "/Iran-Nike-website/";
            dynamicHeader.insertAdjacentHTML(
                "beforeend",
                `<div class="signin-signup basic-gray">
                          <a href="${window.location.pathname == '/Iran-Nike-website/html/store.html' ? baseUrl + 'login.html' : baseUrl + 'html/logIn.html'}" class="basic-flex">
