    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (usserLoggedIn) {
            ...
            dynamicHeader.insertAdjacentHTML(
                ...
                <a href="${window.location.href == `/Iran-Nike-website/html/store.html` ? `./cart.html` : `./html/cart.html` }" class="basic-flex">
            ...
            dynamicHeader.insertAdjacentHTML(
                ...
                `<div class="signin-signup basic-gray">
                        <a href="${window.location.href == '/Iran-Nike-website/index.html' ? './login.html' : './html/login.html' }" class="basic-flex">
